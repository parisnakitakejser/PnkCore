...
| CAPA Exam Prep: Argo Rollouts - Argo Rollouts - Installing Argo Rollouts | [Resources](cncf-certifications/capa/domains/argo-rollouts/installing-argo-rollouts/README.md), [Youtube](https://youtu.be/EM-GlksbfsQ) |
...
| CCA Exam Prep: Network Observability - Debugging DROPPED Flows | [Resources](cncf-certifications/cca/domains/network-observability/03-debugging-dropped-flows/README.md) |
| CCA Exam Prep: Network Observability - Network Policy Observability | [Resources](cncf-certifications/cca/domains/network-observability/04-network-policy-observability/README.md) |
...
|---------------|----------------|------|
| Setup your own local test environment  |Guides you to setup Kubernetes as a playground. |  [YouTube](https://youtu.be/-uqXhRC5uMs), [Medium](https://pnk.sh/create-a-home-lab-running-kubernetes-multi-node-cluster-with-cilium-as-cni-98d8fafd74ee), [Resources](kubernetes/infrastructure/setup-your-own-local-test-environment/README.md) |
